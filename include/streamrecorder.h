...
#define TIZEN_ERROR_STREAMRECORDER       -0x01B0000
...
typedef enum {
	...
	STREAMRECORDER_ERROR_SOUND_POLICY          = TIZEN_ERROR_STREAMRECORDER | 0x03
...
typedef enum {
	...
	STREAMRECORDER_NOTIFY_STATE_CHANGED_BY_SOUNDPOLICY,  /**< The notification of state changed by sound policy*/
